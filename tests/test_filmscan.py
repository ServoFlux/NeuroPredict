...
from wmd.filmscan import contact_sheet_from_volume, grid_shape_for_depth, volume_from_contact_sheet
from wmd.synthetic import make_etiology_volume
def test_grid_shape_for_depth() -> None:
    assert grid_shape_for_depth(64, 8) == (8, 8)
    assert grid_shape_for_depth(50, 8) == (7, 8)
