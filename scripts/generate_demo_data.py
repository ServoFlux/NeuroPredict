...
def main() -> None:
    ...
    parser.add_argument('--multiclass', action='store_true', help='Generate per-etiology classes (cause) instead of binary.')
    args = parser.parse_args()
    manifest = generate_dataset(args.out, n_per_class=args.n_per_class, with_clinical=args.with_clinical, multiclass=args.multiclass)
